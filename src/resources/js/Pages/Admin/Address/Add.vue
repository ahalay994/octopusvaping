...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                name: '',
                lat: '53.910918006701806',
                lon: '27.558691578615726',
                work: '',
            }, {
                resetOnSuccess: true,
                forceFormData: true
            ...
            editorConfig: {
                ...
                plugins: [
                    ...
                    'searchreplace visualblocks lists code fullscreen',
                    'print preview anchor insertdatetime media',
                    'paste lists code help wordcount table'
                ],
                toolbar:
    ...
    methods: {
        submit() {
            this.form.post(this.route('admin.address.add'), {
                onSuccess: (response) => {}
            })
        },
        getCoords(val) {
